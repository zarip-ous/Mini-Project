...
lblformat3 = Label(group1, text = "36.5",bg='#c5d36c',fg='#684400')
...
lblId_Number.grid(row=3, column=0,pady=10)
lblTemperature.grid(row=4, column=0,pady=10)
lblDate.grid(row=5, column=0,pady=10)
lblformat.grid(row=6,column=1,pady=0)
entName.grid(row=2, column=1)
entId_Number.grid(row=3, column=1)
entTemperature.grid(row=4, column=1)
